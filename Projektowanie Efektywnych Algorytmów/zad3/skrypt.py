...
def main():
    if not os.path.exists(PROGRAM_EXE):
        print(f"[BLAD] Skompiluj najpierw program! Nie ma pliku {PROGRAM_EXE}.")
        sys.exit(1)
    ...
    for inst in instances:
        ...
        tuning_sets = [
            ...
            {"POPULATION_SIZE": 100, "MUTATION_RATE": 0.20, "GENERATIONS": 2000, "MUTATION_METHOD": "swap", "CROSSOVER_METHOD": "OX"},
